...
// CreateFulfilled mocks base method.
func (m *MockOrderRepository) CreateFulfilled(order shopify.Order) (shopify.Order, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateFulfilled", order)
	ret0, _ := ret[0].(shopify.Order)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateFulfilled indicates an expected call of CreateFulfilled.
func (mr *MockOrderRepositoryMockRecorder) CreateFulfilled(order interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateFulfilled", reflect.TypeOf((*MockOrderRepository)(nil).CreateFulfilled), order)
}
