...
func (m *MockInventoryItemRepository) Update(inventoryItem v2.InventoryItem) (v2.InventoryItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", inventoryItem)
	ret0, _ := ret[0].(v2.InventoryItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockInventoryItemRepositoryMockRecorder) Update(inventoryItem interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockInventoryItemRepository)(nil).Update), inventoryItem)
}
