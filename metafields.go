...
func (m *MockMetafieldRepository) Create(metafield shopify.Metafield) (shopify.Metafield, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", metafield)
...
func (mr *MockMetafieldRepositoryMockRecorder) Create(metafield interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockMetafieldRepository)(nil).Create), metafield)
}
